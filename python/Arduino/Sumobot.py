...
import keypad  # Para leer el botón BOOT
...
ib = IdeaBoard()  # Instanciación I/O y funciones del Ideaboard
...
def lookForward():
    # Con el sensor ultrasónico mide la distancia al objeto de enfrente
...
def forwardCheck(t, speed, th):
    ...
    for i in range(d):
        ...
        if status == 0:
            ...
            # toca linea blanca atrás... Full speed adelante!!!
...
def esperar_boton():
    # Espera hasta que el botón BOOT sea soltado
    print("Esperando botón...")
    ib.pixel = (255, 100, 0)  # naranja = esperando inicio
...
###### CODIGO PRINCIPAL #######
# valor entre negro y blanco, importante calibraaaaaar!
th = 3800

# Espera una sola vez antes de arrancar
stop()
esperar_boton()
